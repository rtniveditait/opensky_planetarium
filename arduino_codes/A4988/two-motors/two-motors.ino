...
int ENA = 7; 
int RST1 = A2;              // Porta digital D08 - reset do A4988
int SLP1 = A3;              // Porta digital D09 - dormir (sleep) A4988
int ENA1 = 13;
...
int DIR = 11;              // Porta digital D03 - dire̤̣o (direction) do A4988
int STP = 12;  
...
int CONTADOR = 1600;       // N̼mero de pulsos (passos por volta) 
