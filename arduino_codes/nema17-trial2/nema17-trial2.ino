...
int RST = 4;              // Porta digital D08 - reset do A4988
int SLP = 5;              // Porta digital D09 - dormir (sleep) A4988
...
int MS3 = 4;              // Porta digital D06 - MS3 do A4988
...
int CONTADOR = 2;       // N̼mero de pulsos (passos por volta) 
