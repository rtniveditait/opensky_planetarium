...
int MS1 = 10;              // Porta digital D04 - MS1 do A4988
int MS2 = 9;              // Porta digital D05 - MS2 do A4988
int MS3 = 8;              // Porta digital D06 - MS3 do A4988
int DIR = 2;              // Porta digital D03 - dire̤̣o (direction) do A4988
int STP = 3;              // Porta digital D02 - passo(step) do A4988
...
{
  atraso = 1000000000 / (2*FREQ);    // calculo do tempo de atraso (1/2 periodo) em us
}
/*
void FULL()
{
