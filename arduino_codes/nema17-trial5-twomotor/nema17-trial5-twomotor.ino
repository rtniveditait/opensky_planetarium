...
int MS11 = 6;              // Porta digital D04 - MS1 do A4988
int MS22 = 5;              // Porta digital D05 - MS2 do A4988
int MS33 = 4;              // Porta digital D06 - MS3 do A4988
int DIR2 = 2;              // Porta digital D03 - dire̤̣o (direction) do A4988
int STP2 = 13;              // Porta digital D02 - passo(step) do A4988
...
int CONTADOR = 200;       // N̼mero de pulsos (passos por volta) 
...
void setup()
{
  ...
  FULL() ;                  // Configura modo de avan̤o do motor FULL, HALF, P1_4, P1_8 ou P1_16
...
{
  HOR();
  for(int i=0; i <= 50; i++)              // Incrementa o Contador
   {
